const PRODUCTS = [
  ...
  {
    id: "leather-pot-covers",
    category: "leather",
    subcategory: "Pot Covers",
    name: "Leather Plant Pot Covers",
    ...
    variants: [
      ...
      },
      {
        ...
        description: "The Reddish Brown Leather Plant Pot Cover brings a warm, clay-like, rust or terracotta feel to your foliage. Designed with spatial proportion in mind, this sleeve coordinates beautifully with wooden surfaces.",
        details: [
...
function getProductById(id) {
  ...
  for (const prod of PRODUCTS) {
    if (prod.variants) {
      const v = prod.variants.find(varItem => varItem.id === id);
      if (v) return prod;
    }
  }
  return null;
